...
<div style="background:var(--primary);padding:3rem 0;">
    <div class="container">
        <div class="d-flex align-items-center gap-4 flex-wrap">
            <img src="{{ $instructor->avatarUrl() }}" class="rounded-circle border border-3 border-white"
...
<div class="container py-5">
    <div class="row g-4">
        <div class="col-lg-8">
            <!-- Courses -->
            <h4 class="fw-bold mb-3">Courses by {{ $instructor->name }}</h4>
            <div class="row g-3">
        ...
        <div class="col-lg-4">
            <div class="bg-white rounded-xl shadow-brand p-4">
                ...
                <p class="text-muted" style="font-size:.9rem;white-space:pre-wrap;">{{ $instructor->bio ?? 'This instructor has not added a bio yet.' }}</p>
                @if($instructor->website)
                <a href="{{ $instructor->website }}" class="btn btn-outline-primary w-100 mt-2" target="_blank">
