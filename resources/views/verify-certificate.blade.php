...
<div class="py-5 bg-light-gray" style="min-height:60vh;">
    <div class="container" style="max-width:640px;">
        ...
        <div class="bg-white rounded-xl shadow-brand p-5 text-center">
            ...
            <p class="text-muted">This is a valid ACADEXA certificate.</p>
            ...
            <hr class="my-4">
            <p class="text-muted small">Issued by <strong>ACADEXA</strong> — ZTF University Institute, Bertoua, Cameroon</p>
        </div>
        @else
        <div class="bg-white rounded-xl shadow-brand p-5 text-center">
            <div style="font-size:4rem;">❌</div>
            ...
            <p class="text-muted small">If you believe this is an error, please contact us at {{ $siteSettings['contact_email'] ?? 'info@acadexa.com' }}</p>
        </div>
        @endif
        ...
        <div class="bg-white rounded-xl shadow-brand p-4 mt-4">
            ...
            <form action="" method="GET" class="d-flex gap-2">
                <input type="text" name="code" class="form-control" placeholder="Enter certificate code (e.g., ACADEXA-ABCD-EFGH-2025)">
